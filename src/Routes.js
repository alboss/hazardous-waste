...
import LanguageResourcesPage from './pages/LanguageResourcesPage';
...
// import OrigHomePage from './pages/OrigHomePage'
  ...
  render () {
    return (
      <Switch>
        ...
        <Route exact path='/news-events' component={NewsEventsPage} />
        <Route exact path='/language-resources' component={LanguageResourcesPage} />
        <Route exact path='/customer-serivce' component={CustomerServicePage} />
