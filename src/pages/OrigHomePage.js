            ...
            <CardBody>
              ...
              <Row className='d-flex flex-row justify-content-center row'>
                <a
                  ...
                  <Fa icon='graduation-cap' className='mr-2' /> Official Documentation</a>
              </Row>
            </CardBody>
            </Col>
          </Row>
        ...
        <Container>
          <Row>
            ...
            <Row id='categories'>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/css'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo lighten-2' to='/components'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/advanced'>
                Learn more
              </NavLink>
              </Col>
              </Col>
            ...
            <Row id='categories'>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/navigation'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo lighten-2' to='/forms'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/tables'>
                Learn more
              </NavLink>
              </Col>
              </Col>
            ...
            <Row id='categories'>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/modals'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo lighten-2' to='/extended'>
                Learn more
              </NavLink>
              </Col>
              </Col>
              ...
              <NavLink tag='button' className='btn btn-sm indigo darken-3' to='/sections'>
                Learn more
              </NavLink>
              </Col>
              </Col>
